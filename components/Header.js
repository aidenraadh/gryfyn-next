...
export default function Header(){
    ...
    return (<>
        <nav  className="fixed top-0 left-0 flex flex-col items-center mobile:justify-start laptop:justify-between desktop:justify-between h-screen gap-0 p-4 bg-black py-7 mobile:py-2 tablet:flex-row tablet:w-full tablet:h-auto navbar">

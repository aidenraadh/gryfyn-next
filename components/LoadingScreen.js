...
export default function LoadingScreen(){
    ...
    return (<>
        <div id="sun-loader" className='absolute top-0 left-0 flex w-screen h-screen bg-transparent tablet:flex-col'>
            ...
            <svg className='w-auto h-screen tablet:w-screen tablet:h-auto shrink-0' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 1280">
                <g>
        ...
        <div id="preloader" className='flex flex-col items-center justify-center'>
            <span className='absolute w-12 h-12 bg-[#E8DFD4] rounded-md rectangle'></span>
            <span className='absolute w-12 h-12 bg-[#E8DFD4] rounded-md rectangle'></span>
